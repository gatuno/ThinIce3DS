...
APP_TITLE := Thin Ice
APP_DESCRIPTION := Play the Thin Ice Arcade Game
APP_AUTHOR := Gatuno
ICON := thinice.png
...
export VPATH	:=	$(foreach dir,$(SOURCES),$(CURDIR)/$(dir)) \
			...
			$(foreach dir,$(ALPHA_GRAPHICS),$(CURDIR)/$(dir))
...
ALPHAFILES  :=  $(foreach dir,$(ALPHA_GRAPHICS),$(notdir $(wildcard $(dir)/*.png)))
